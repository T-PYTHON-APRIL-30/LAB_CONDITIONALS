...
rate= int(input(f"Please Enter your rating for {movie_name}:"))

# Create a popularity score of type float , let it be 72.65
popularity_score=float(input(f"Please Enter the popularity score for{movie_name}:"))
...
if rate >=4 and popularity_score >=80 :
    print("The movie is Highly recommended, Hurry up and book your tichet to the movie")

#else if the movie rating is 3 or greater and the popularity is greater than 70 , print 
